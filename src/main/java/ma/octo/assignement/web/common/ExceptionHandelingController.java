...
public class ExceptionHandelingController {
    ...
    public ResponseEntity<String> handleTrnasactionException(Exception ex , WebRequest request){
        return new ResponseEntity<>(ex.getMessage(),null,HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(Exception.class)
    public ResponseEntity<String> handleGeneralExcepyion(Exception ex , WebRequest request){
        return new ResponseEntity<>("Probléme dans l'application" , null , HttpStatus.INTERNAL_SERVER_ERROR);
    }
}
